...
public:
    ...
    static Uint32 getButtons() { return buttons; }
    static Uint32 getLastButtons() { return lastButtons; }
    static float getWorldX() { return worldX; }
    static float getWorldY() { return worldY; }
};
